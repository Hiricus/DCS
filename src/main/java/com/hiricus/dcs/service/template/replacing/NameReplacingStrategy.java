...
@Component
public class NameReplacingStrategy extends ReplacingStrategy {
    private final UserDataRepository userDataRepository;

    public NameReplacingStrategy(@Value("NAME") String keyword, UserDataRepository userDataRepository) {
        super(keyword);
