...
@Component
public class PatronymicReplacingStrategy extends ReplacingStrategy {
    private final UserDataRepository userDataRepository;

    public PatronymicReplacingStrategy(@Value("PATRONYMIC") String keyword, UserDataRepository userDataRepository) {
        super(keyword);
